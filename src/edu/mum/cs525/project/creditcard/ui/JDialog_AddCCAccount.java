...
public class JDialog_AddCCAccount extends javax.swing.JDialog
{
	...
	public JDialog_AddCCAccount(Consumer<CreditAccount> callback)
	{
	...
	{
		PersonalCustomer cus = accountService.createPersonalCustomer();
		cus.setName(JTextField_NAME.getText());
		cus.setEmail(JTextField_Email.getText());
		
		Address address = new Address();
		address.setStreet(JTextField_STR.getText());
		address.setCity(JTextField_CT.getText());
		address.setState(JTextField_ST.getText());
		address.setZip(JTextField_ZIP.getText());
		
		cus.setAddress(address);
		
		String accountNumber = JTextField_CCNR.getText(); 
		
		CreditAccount acc = JRadioButton_Gold.isSelected() ? 
								accountService.createGoldAccount(accountNumber, cus) :
							JRadioButton_Silver.isSelected() ?
								accountService.createSilverAccount(accountNumber, cus) :
								accountService.createBronzeAccount(accountNumber, cus);
