...
public class JDialog_Withdraw extends javax.swing.JDialog
{
	...
	public JDialog_Withdraw(String accountNumber, Consumer<Double> callback)
	{
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
		...
		try {
			purchaseAmount = Double.valueOf(JTextField_AMT.getText());
		...
		if (purchaseAmount <= 0.) {
			JOptionPane.showMessageDialog(null, "Withdrawal amount should be greater than 0.");
			return;
		}
		
		if (null != callback) {
			callback.accept(purchaseAmount);
		}
