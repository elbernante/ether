...
public class JDialog_AddCompAcc extends javax.swing.JDialog
{
	...
	public JDialog_AddCompAcc(Consumer<Account> callback)
	{
	...
	{
		BusinessCustomer cus = accountService.createBusinessCutomer();
		cus.setName(JTextField_NAME.getText());
		cus.setEmail(JTextField_EM.getText());
		try {
			cus.setNumberOfEmployees(Integer.valueOf(JTextField_NoOfEmp.getText()));
		} catch (NumberFormatException e) {
			cus.setNumberOfEmployees(0);
		}
		...
		Account acc = JRadioButton_Chk.isSelected() ? 
							accountService.createCheckingAccount(accountNumber, cus) :
							accountService.createSavingsAccount(accountNumber, cus);
		if (null != callback) {
			callback.accept(acc);
		}
	   dispose();
